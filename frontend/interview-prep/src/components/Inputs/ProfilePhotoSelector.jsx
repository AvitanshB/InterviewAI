      ...
      {!image ? (
        <div className=" bg-orange-50 w-20 h-20 rounded-full flex justify-center items-center relative">
          ...
          <button
            ...
            className="bg-linear-to-r from-orange-500/85 to-orange-600 text-white rounded-full h-8 w-8 flex justify-center items-center absolute -bottom-1 -right-1 cursor-pointer"
          >
            <LuUpload />
          </button>
        </div>
